      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Sistema Respiratorio - Fisiología</h1>
            <p class="header-subtitle">Fisiología Respiratoria · Nivel Universitario</p>
          </div>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar pulmón, bronquio, alvéolo, ventilación, intercambio gaseoso..."
    ...
    return `
      <footer class="footer">
        <div class="footer-content">
          <p><strong>Fuente:</strong> Contenido basado en <em>West's Respiratory Physiology (2021) 11th ed.; Levitzky (2023) Pulmonary Physiology, 10th ed.; Murray & Nadel (2022) Textbook of Respiratory Medicine, 7th ed.</em></p>
