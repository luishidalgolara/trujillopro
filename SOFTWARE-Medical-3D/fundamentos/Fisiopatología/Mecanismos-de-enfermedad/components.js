      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Mecanismos de Enfermedad</h1>
            <p class="header-subtitle">Fisiopatología · Nivel Universitario</p>
          </div>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar mecanismo, mediador, enfermedad, célula..."
    ...
    return `
      <footer class="footer">
        <div class="footer-content">
          <p><strong>Fuente:</strong> Contenido basado en <em>Robbins & Cotran Pathologic Basis of Disease, 10th ed. (2021); Kumar, Abbas & Aster Basic Pathology, 11th ed. (2023); Rubin's Pathology, 8th ed. (2020)</em></p>
