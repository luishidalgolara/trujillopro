      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Mecanismos de Transporte Celular</h1>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar transporte, canal, bomba, difusión, endocitosis, enfermedad..."
  ...
  createNoResults() {
    return `
      <div class="no-results visible">
        ...
        <p class="no-results-text">No se encontraron mecanismos de transporte con el criterio de búsqueda.</p>
      </div>
    `;
  },
