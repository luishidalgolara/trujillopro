      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Tejido Nervioso: Neuronas, Glía y Transmisión</h1>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar neurona, sinapsis, potencial de acción, glía, neurotransmisor..."
  ...
  createNoResults() {
    return `
      <div class="no-results visible">
        ...
        <p class="no-results-text">No se encontraron elementos del tejido nervioso con el criterio de búsqueda.</p>
      </div>
    `;
  },
    ...
    return `
      <footer class="footer">
        <div class="footer-content">
          <p><strong>Fuente:</strong> Contenido basado en <em>Purves et al. (2018) Neuroscience, 6th ed.; Kandel et al. (2021) Principles of Neural Science, 6th ed.</em></p>
