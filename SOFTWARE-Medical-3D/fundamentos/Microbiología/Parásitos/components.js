      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Ciclos de Vida y Patología de Parásitos</h1>
            <p class="header-subtitle">Parasitología · Nivel Universitario</p>
          </div>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar parásito, ciclo de vida, hospedador, enfermedad..."
  ...
  createNoResults() {
    return `
      <div class="no-results visible">
        ...
        <p class="no-results-text">No se encontraron parásitos con el criterio de búsqueda.</p>
      </div>
    `;
  },
    ...
    return `
      <footer class="footer">
        <div class="footer-content">
          <p><strong>Fuente:</strong> Contenido basado en <em>Markell & Voge (2021) Medical Parasitology, 10th ed.; Despommier et al. (2019) Parasitic Diseases, 7th ed.</em></p>
