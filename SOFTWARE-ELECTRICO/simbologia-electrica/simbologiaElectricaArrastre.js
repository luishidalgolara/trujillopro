// ============================================================
// SIMBOLOGÍA ELÉCTRICA ARRASTRE - Funcionalidad de drag & drop
// ============================================================

function inicializarArrastreElectrica() {
    const header = document.getElementById('simbologiaElectricaHeader');
...
console.log('✅ Simbología Eléctrica Arrastre inicializado');
