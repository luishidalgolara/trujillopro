      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Estructura y Clasificación de Bacterias</h1>
            <p class="header-subtitle">Microbiología · Nivel Universitario</p>
          </div>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar bacteria, estructura, enfermedad, mecanismo..."
  ...
  createNoResults() {
    return `
      <div class="no-results visible">
        ...
        <p class="no-results-text">No se encontraron bacterias con el criterio de búsqueda.</p>
      </div>
    `;
  },
    ...
    return `
      <footer class="footer">
        <div class="footer-content">
          <p><strong>Fuente:</strong> Contenido basado en <em>Murray et al. (2021) Medical Microbiology, 9th ed.; Willey et al. (2020) Prescott's Microbiology, 11th ed.</em></p>
