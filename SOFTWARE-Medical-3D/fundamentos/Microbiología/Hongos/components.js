      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Estructura y Clasificación de Hongos</h1>
            <p class="header-subtitle">Micología · Nivel Universitario</p>
          </div>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar hongo, morfología, enfermedad, dimorfismo..."
  ...
  createNoResults() {
    return `
      <div class="no-results visible">
        ...
        <p class="no-results-text">No se encontraron hongos con el criterio de búsqueda.</p>
      </div>
    `;
  },
    ...
    return `
      <footer class="footer">
        <div class="footer-content">
          <p><strong>Fuente:</strong> Contenido basado en <em>Larone (2023) Medically Important Fungi, 7th ed.; de Hoog et al. (2020) Atlas of Clinical Fungi, 4th ed.</em></p>
