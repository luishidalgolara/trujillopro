      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            ...
            <p class="header-subtitle">Neurofisiología · Nivel Universitario</p>
          </div>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar canal iónico, neurotransmisor, receptor, enfermedad..."
    ...
    return `
      <footer class="footer">
        <div class="footer-content">
          <p><strong>Fuente:</strong> Contenido basado en <em>Kandel et al. Principles of Neural Science, 6th ed. (2021); Purves et al. Neuroscience, 6th ed. (2018); Hille, Ion Channels of Excitable Membranes, 3rd ed. (2001)</em></p>
