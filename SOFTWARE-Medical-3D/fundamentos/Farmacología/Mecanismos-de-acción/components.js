      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Mecanismos de Acción Farmacológicos</h1>
            <p class="header-subtitle">Farmacodinamia · Nivel Universitario</p>
          </div>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar fármaco, mecanismo, receptor, enzima, indicación..."
    ...
    return `
      <section class="card-section clinical-section">
        ...
        <div class="clinical-content">
          <strong>🔴 Aplicaciones clínicas:</strong>
          <ul>
            ${seccion.items.map(item => `
              <li>${shouldHighlight ? utils.highlightText(item, state.searchTerm) : item}</li>
            `).join('')}
  ...
  createNoResults() {
    return `
      <div class="no-results visible">
        ...
        <p class="no-results-text">No se encontraron mecanismos de acción con el criterio de búsqueda.</p>
      </div>
    `;
  },
    ...
    return `
      <footer class="footer">
        <div class="footer-content">
          ...
          <p><strong>Última actualización:</strong> Febrero 2025 · Nivel universitario · Información médica verificada</p>
        </div>
      </footer>
    `;
  }
