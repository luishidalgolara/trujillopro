...
const TracerConfig = {
    ...
    circuitColors: {
        ...
        'entre-niveles': '#9c27b0'      // Púrpura - Conexión entre niveles
    },
    ...
    elementCategories: {
        ...
        especiales: ['enchufe-especial'],
        electrodomesticos: ['lavadora', 'secadora', 'refrigerador', 'microondas', 'horno', 'cocina', 'calefon'],
        interruptores: ['int-simple', 'int-doble', 'conmutador', 'pulsador'],
        tierra: ['jabalina', 'conductor-tierra', 'tierra-enchufe'],
        'entre-niveles': ['subida-nivel']
    },
