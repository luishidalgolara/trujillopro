...
function handleZoomWheel(e) {
    ...
    updateStatus(`🔍 Zoom: ${Math.round(AppState.zoom * 100)}%`);
}
...
function updateElementSizes() {
    ...
    // Actualizar círculos de símbolos
    ...
    // Actualizar líneas de conductores
...
function initializeZoomPan() {
    ...
    if (!wrapper || !svg) {
        console.error('❌ No se encontró canvas-wrapper o SVG');
        return;
    }
    ...
    console.log('✅ Sistema Zoom/Pan CAD inicializado');
    updateStatus('✅ Sistema de zoom activado - Rueda: zoom | Botón medio/Nav: pan');
}
