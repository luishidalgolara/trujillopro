      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Estructura y Clasificación de Virus</h1>
            <p class="header-subtitle">Virología · Nivel Universitario</p>
          </div>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar virus, genoma, enfermedad, ciclo replicativo..."
  ...
  createNoResults() {
    return `
      <div class="no-results visible">
        ...
        <p class="no-results-text">No se encontraron virus con el criterio de búsqueda.</p>
      </div>
    `;
  },
    ...
    return `
      <footer class="footer">
        <div class="footer-content">
          <p><strong>Fuente:</strong> Contenido basado en <em>Knipe & Howley (2020) Fields Virology, 7th ed.; Flint et al. (2020) Principles of Virology, 5th ed.</em></p>
