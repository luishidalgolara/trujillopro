      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Sistema Endocrino - Fisiología</h1>
            <p class="header-subtitle">Fisiología Endocrina · Nivel Universitario</p>
          </div>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar hormona, glándula, diabetes, tiroides, insulina..."
    ...
    return `
      <footer class="footer">
        <div class="footer-content">
          <p><strong>Fuente:</strong> Contenido basado en <em>Williams Textbook of Endocrinology (2023) 15th ed.; Greenspan's Basic & Clinical Endocrinology (2021) 11th ed.; Melmed et al. The Pituitary (2022) 4th ed.</em></p>
