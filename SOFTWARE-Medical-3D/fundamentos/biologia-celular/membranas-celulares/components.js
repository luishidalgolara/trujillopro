      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Estructura y Función de Membranas Celulares</h1>
            <p class="header-subtitle">Biología Celular · Nivel Universitario</p>
          </div>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar membrana, estructura, transporte, señalización, enfermedad..."
  ...
  createNoResults() {
    return `
      <div class="no-results visible">
        ...
        <p class="no-results-text">No se encontraron temas de membranas con el criterio de búsqueda.</p>
      </div>
    `;
  },
