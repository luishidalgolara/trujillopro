...
const LineRenderer = {
    ...
    // ========================================
    // ✅ MODIFICADO - Dibujar línea de alimentación principal
    // SOLO DIBUJA HACIA TABLERO DE ILUMINACIÓN
    // ========================================
    drawMainFeed(infrastructure) {
        // ✅ VALIDAR QUE EL TABLERO SEA DE TIPO ILUMINACIÓN
        if (infrastructure.tablero && infrastructure.tablero.tableroTipo !== 'iluminacion') {
            console.log('⚠️ Tablero no es de iluminación, omitiendo alimentación principal');
            return;
        }
        ...
        console.log('✅ Línea de alimentación principal dibujada (solo para tablero de iluminación)');
    },
