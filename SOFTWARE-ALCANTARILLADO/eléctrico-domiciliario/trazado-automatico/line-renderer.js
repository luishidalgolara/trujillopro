...
const LineRenderer = {
    ...
    getCircuitColor(circuitName) {
        if (circuitName === 'C1') return TracerConfig.circuitColors.iluminacion;
        if (circuitName === 'C2') return TracerConfig.circuitColors.enchufes;
        if (circuitName === 'C5') return TracerConfig.circuitColors.especial;
        if (circuitName === 'PE') return TracerConfig.circuitColors.tierra;
        return '#95a5a6';
    },
    
    // Obtener calibre según circuito
    getCircuitCalibre(circuitName) {
        if (circuitName === 'C1') return TracerConfig.conductorSize.iluminacion;
        if (circuitName === 'C2') return TracerConfig.conductorSize.enchufes;
        if (circuitName === 'C5') return TracerConfig.conductorSize.especial;
        if (circuitName === 'PE') return TracerConfig.conductorSize.tierra;
        return '2.5mm²';
    },
