      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Tejido Muscular: Estructura y Contracción</h1>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar tipo de músculo, sarcómero, contracción, proteína..."
  ...
  createNoResults() {
    return `
      <div class="no-results visible">
        ...
        <p class="no-results-text">No se encontraron tipos de músculo con el criterio de búsqueda.</p>
      </div>
    `;
  },
    ...
    return `
      <footer class="footer">
        <div class="footer-content">
          <p><strong>Fuente:</strong> Contenido basado en <em>Ross & Pawlina (2020) Histology: A Text and Atlas, 8th ed.; Koeppen & Stanton (2018) Berne & Levy Physiology, 7th ed.</em></p>
