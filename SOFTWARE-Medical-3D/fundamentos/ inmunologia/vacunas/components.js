      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Vacunas</h1>
            <p class="header-subtitle">Inmunización Activa y Pasiva · Nivel Universitario</p>
          </div>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar sarampión, mRNA, adjuvantes, inmunoglobulina, eficacia..."
    ...
    return `
      <footer class="footer">
        <div class="footer-content">
          <p><strong>Fuente:</strong> Contenido basado en <em>Plotkin's Vaccines, 8th ed. (2023); WHO Position Papers (2023-2025); CDC Pink Book - Epidemiology and Prevention of Vaccine-Preventable Diseases, 14th ed. (2021)</em></p>
