      ...
      <header class="header">
        <div class="header-content">
          ...
          <div class="header-title">
            <h1>Inflamación</h1>
            <p class="header-subtitle">Respuesta Inflamatoria Aguda y Crónica · Nivel Universitario</p>
          </div>
      ...
      <section class="search-section">
        <div class="search-container">
          ...
          <input 
            ...
            class="search-input" 
            id="searchInput"
            placeholder="Buscar neutrófilos, histamina, prostaglandinas, citocinas, edema..."
    ...
    return `
      <footer class="footer">
        <div class="footer-content">
          <p><strong>Fuente:</strong> Contenido basado en <em>Robbins & Cotran Pathologic Basis of Disease, 10th ed. (2021); Kumar, Abbas & Aster - Basic Pathology, 11th ed. (2023); Medzhitov - Nature (2008) Origin and physiological roles of inflammation</em></p>
