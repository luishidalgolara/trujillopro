...
function init() {
  console.log('🫀 Inicializando aplicación de Anatomía Macroscópica...');
  ...
  console.log('%c  AnatomiaApp.goToOrganelo("corazon")', 'color: #666;');
  console.log('%c  AnatomiaApp.searchOrganelo("pulmon")', 'color: #666;');
